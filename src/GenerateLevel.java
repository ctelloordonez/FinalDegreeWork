...
//            String level = generator.getGeneratedLevel(new MarioLevelModel(150, 16), new MarioTimer(5 * 60 * 60 * 1000));
//            MarioGame game = new MarioGame();
//            printResults(game.runGame(new agents.carlosTello.Recorder(new agents.robinBaumgarten.Agent(), "RecordedMarioDatasetGenerate3"), level, 20, 0, false));
//
//        }
        MarioLevelGenerator generator = new levelGenerators.notch.LevelGenerator();
        String level = generator.getGeneratedLevel(new MarioLevelModel(150, 16), new MarioTimer(5 * 60 * 60 * 1000));
        MarioGame game = new MarioGame();
        printResults(game.runGame(new agents.carlosTello.Agent("RecordedMarioDatasetGenerate3"), level, 20, 0, true));
